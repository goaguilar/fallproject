...
{
    //extracting the latitude and longitude from place
    //and converting it into location
    var location = new google.maps.LatLng(place["latitude"], place["longitude"]);

    //sticking with the simple google beach flag
    ...
    //starts this mess when the marker is clicked
    google.maps.event.addListener(marker, 'click', function(){
        ...
        $.getJSON(Flask.url_for("articles"), {geo: place["postal_code"]}, function(articles) {
            ...
            // close the list
    		content += "</ul>";
    		//supposed to show info on the marker with the article conente
